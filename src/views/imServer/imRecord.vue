...
.imRecord-wrapper > .main .item-list .item.active, .imRecord-wrapper > .main .item-list .item:hover
  background-color #0095ff

.imRecord-wrapper > .main .item-list .item.active .info-wrapper .first-p .name, .imRecord-wrapper > .main .item-list .item.active .info-wrapper .second-p .lastMsgContent, .imRecord-wrapper > .main .item-list .item.active .info-wrapper .first-p .lastMsgTime, .imRecord-wrapper > .main .item-list .item:hover .info-wrapper .first-p .name, .imRecord-wrapper > .main .item-list .item:hover .info-wrapper .second-p .lastMsgContent, .imRecord-wrapper > .main .item-list .item:hover .info-wrapper .first-p .lastMsgTime
  color #eaf4fb

.imRecord-wrapper > .main .item-list .item.active .iconfont, .imRecord-wrapper > .main .item-list .item:hover .iconfont
